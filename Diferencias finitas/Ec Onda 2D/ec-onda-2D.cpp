...
void walls(double **UU, double *x, double *y, double Nx, double Ny)
{
    for (int i = 0; i < Nx+1; i++)
    {
        for (int j = 0; j < Ny+1; j++)
        {
            if (x[i] <= 0.2 && y[i] >= 0.2)
                UU[i][j] = 0.0;
            else if(x[i] >= 0.8 && y[i] >= 0.2)
                UU[i][j] = 0.0;
            else if(x[i] >= 0.8 && y[i] <= 0.2)
                UU[i][j] = 0.0;
            else if(x[i] <= 0.2 && y[i] <= 0.2)
                UU[i][j] = 0.0;    
        }
    }   
}
