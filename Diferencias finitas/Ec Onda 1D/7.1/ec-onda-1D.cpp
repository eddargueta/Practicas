...
{
    // return exp(-100*pow(x-0.75,2)) + exp(-100*pow(x-0.25,2)); // Inter. constructiva.
    
    return exp(-100*pow(x-0.75,2)) - exp(-100*pow(x-0.25,2)); // Inter. destructiva.
...
double g_cond_ini(double x)
{
    ...
    // 200*v*(x-0.25)*exp(-100*pow(x-0.25, 2)); // Inter. constructiva.
    
    return -200*v*(x-0.75)*exp(-100*pow(x-0.75, 2)) - 
    200*v*(x-0.25)*exp(-100*pow(x-0.25, 2)); // Inter. destructiva.
...
int main()
{
    ...
    // Salida en t=0.
    salidaSolucion(of, u_vieja, x, tiempo, N);
