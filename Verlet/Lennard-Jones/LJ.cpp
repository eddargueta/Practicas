...
// Constantes.
const double l  = 15.0; // Lado del cuadrado (unidades sigma).
const double rc = 2.5;  // 2.5*sigma radio de corte.
const double T0 = 0.5; // Temperatura de referencia.
...
int main()
{
    ...
    // Archivos de salida.
    ofstream of_posicion("T05-posicion.dat", ios::out);
    ofstream of_velocidad("T05-velocidad.dat", ios::out);
    ofstream of_energia("T05-energia.dat", ios::out);
